...
plt.plot(avg_ist_regregpts_gpts, "-", label="ist avg regrets gpts", color="r")
...
plt.plot(std_ist_regregpts_gpts, "-", label="ist std regrets gpts", color="r")
plt.plot(std_ist_regregpts_gpucb, "-", label="ist std regrets gpucb", color="g")
plt.legend()
...
plt.plot(avg_cumsum_regregpts_gpts, "-", label="cumsum avg regrets gpts", color="r")
plt.plot(avg_cumsum_regregpts_gpucb, "-", label="cumsum avg regrets gpucb", color="g")
plt.legend()
...
plt.plot(std_cumsum_regregpts_gpts, "-", label="cumsum std regrets gpts", color="r")
plt.plot(std_cumsum_regregpts_gpucb, "-", label="cumsum std regrets gpucb", color="g")
plt.legend()
