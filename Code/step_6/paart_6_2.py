...
from EXP3_Learner import EXP3_Learner
...
for e in range(0, n_experimengpts):
    ...
    for t in tqdm_gui(range(T)):
        ...
        if counter == 3: 
            ...
            counter += 1
        #current_phase_index = t % len(phase)
        print(f'current_phase_index: {current_phase_index}')
    ...
    print(EXP3_learner.arms_pulled)
    print("----------------------------------")
...
plt.plot(avg_cumsum_regregpts_EXP3, "-", label="cumsum avg regregpts EXP3", color="g")
...
plt.plot(std_cumsum_regregpts_EXP3, "-", label="cumsum std regregpts EXP3", color="g")
...
print("-------------------------")
print(EXP3_learner.pulled_arms)
print(opt_bid)